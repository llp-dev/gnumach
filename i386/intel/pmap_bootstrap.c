...
/* Forward declarations for functions provided by Rust PMAP library */
extern pt_entry_t *pmap_pte(const pmap_t pmap, vm_offset_t addr);
extern pt_entry_t *pmap_pde(const pmap_t pmap, vm_offset_t addr);
...
#endif
#if 0  /* Rust provides pmap_pde/pmap_pte/pmap_l4base/pmap_ptp */
...
#endif  /* Rust provides pmap_pde/pmap_pte/pmap_l4base/pmap_ptp */
	}
 ...
 */
#if 0  /* Rust provides pmap_map_bd */
...
#if 0  /* === Everything below until line 3239 is provided by Rust PMAP === */
/*
...
#endif  /* === End of Rust-provided functions === */
